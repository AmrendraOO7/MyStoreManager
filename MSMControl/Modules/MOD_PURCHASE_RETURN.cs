...
{
    public class MOD_PURCHASE_RETURN_MASTER
    {
        public string ToPerform { get; set; }
        public int PRID { get; set; }
        public string PRVNUM { get; set; }
        public System.DateTime? Purchase_Return_Date { get; set; }
        public string Purchase_Return_Miti { get; set; }
    ...
    public class MOD_PURCHASE_RETURN_DETAILS
    {
