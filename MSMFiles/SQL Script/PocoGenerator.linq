<Query Kind="Program">
  <Connection>
    <ID>ece8519d-8da2-4b5d-94bb-f6a121cc3e26</ID>
    <Persist>true</Persist>
    <Server>AMRENDRA\DATA_CENTRE</Server>
    <SqlSecurity>true</SqlSecurity>
    <UserName>sa</UserName>
    <Password></Password>
    <Database>MSM_NB S97</Database>
...
void Main()
{
	...
	{
	 	var classCode = conn.GenerateClass("select * from MSM.IssueCardDetails");
